...
def check_lens_compatibility(
    ...
    *,
    ...
    if not isinstance(provenance, dict) or not provenance:
        ...
        return LensCompatibility(tuple(errors), tuple(warnings), tuple(compared))
    ...
    if artifact_model_name and runtime_model_name:
        ...
        if not model_names_match:
            ...
            if _is_local_model_path(runtime_model_name):
                ...
                errors.append(f"{message}; this lens was fitted for a different model")
    ...
    if artifact_tokenizer_hash:
        try:
            ...
            if artifact_tokenizer_hash != runtime_tokenizer_hash:
                errors.append("lens tokenizer fingerprint does not match the loaded tokenizer")
...
def require_lens_compatible(
    ...
    *,
    ...
    """Raise for confirmed conflicts and log unverifiable legacy evidence once."""
    ...
    if result.errors:
        raise ValueError("incompatible fitted lens: " + "; ".join(result.errors))
